   <header
       ...
       <div class="col-md-2 text-center ">
           <a href="{{ route('login') }}"><button   type="button" class="btn btn-outline-primary me-2">Đăng nhập</button> </a>
           <a href="{{ route('register') }}"><button type="button" class="btn btn-primary">Đăng ký</button></a>
       </div>
